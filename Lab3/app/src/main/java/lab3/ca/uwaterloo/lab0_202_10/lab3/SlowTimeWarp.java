...
public class SlowTimeWarp extends TimeSeriesDistanceCalculator {

    private float[][][] matrix;
    private float[][][] distance;

    public SlowTimeWarp(DistanceCalculator distanceCalculator) {
    ...
    public float distance(TimeSeries recorded, TimeSeries reference) {
        ...
        this.matrix = new float[numDimensions][recorded.size() + 1][reference.size() + 1];
        this.distance = new float[numDimensions][recorded.size()][reference.size()];
